...
model = Net()
model.load_state_dict(torch.load("model1170.pt", map_location=torch.device('cpu')))
...
b.push(Move.from_uci("d7d5"))
b.push(Move.from_uci("c2c4"))
b.push(Move.from_uci("e7e5"))
b.push(Move.from_uci("d4e5"))
b.push(Move.from_uci("d5d4"))
b.push(Move.from_uci("e2e3"))
b.push(Move.from_uci("f8b4"))
b.push(Move.from_uci("c1d2"))
b.push(Move.from_uci("d4e3"))
